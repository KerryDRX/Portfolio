...
class UNet3D(nn.Module):
    def __init__(self, in_channels, num_classes, channels=[32, 64, 128, 256], act='identity', eps=0):
...
def build_model(act, eps):
    return UNet3D(in_channels=1, num_classes=3, act=act, eps=eps)
