...
deepssm_directory = f'{dataset_directory}DeepSSM_nosmooth/'
groom_directory = f'{deepssm_directory}groomed/'
mesh_directory = f'{deepssm_directory}mesh/'
aug_directory = f'{deepssm_directory}augmentation99/'
loader_directory = f'{deepssm_directory}torch_loaders99/'
